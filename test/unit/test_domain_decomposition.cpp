...
struct dummy_context {
    ...
    partitioned_vector<spike> all_to_all_spikes(const partitioned_vector<spike>& local_spikes) const { throw unimplemented{__FUNCTION__}; }
    ...
    partitioned_vector<cell_member_type> all_to_all_gids_domains(const std::vector<std::vector<cell_member_type>> gids_domains) const { throw unimplemented{__FUNCTION__};}
...
TEST(domain_decomposition, hints) {
    ...
    auto D = partition_load_balance(rec, ctx, hints);
