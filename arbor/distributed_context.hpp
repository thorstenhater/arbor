...
public:
    ...
    partitioned_vector<spike> all_to_all_spikes(const partitioned_vector<spike>& local_spikes) const {
    ...
    partitioned_vector<cell_member_type> all_to_all_gids_domains(const std::vector<std::vector<cell_member_type>>& local_spikes) const {
...
private:
    struct interface {
        ...
        virtual partitioned_vector<spike> 
        all_to_all_spikes(const partitioned_vector<spike>& local_spikes) const = 0;
        ...
        virtual partitioned_vector<cell_member_type>
    ...
    struct wrap: interface {
        ...
        partitioned_vector<spike>
        all_to_all_spikes(const partitioned_vector<spike>& local_spikes) const override {
        ...
        partitioned_vector<cell_member_type>
...
struct local_context {
    ...
    partitioned_vector<spike> all_to_all_spikes(const partitioned_vector<spike>& local) const {
        using count_type = typename partitioned_vector<spike>::count_type;
        ...
        return partitioned_vector<spike>(std::move(gathered), std::move(partition));
    }
    std::vector<spike>
    ...
    partitioned_vector<cell_member_type> all_to_all_gids_domains(const std::vector<std::vector<cell_member_type>>& gids_domains) const {
        using count_type = typename partitioned_vector<cell_member_type>::count_type;
        ...
        return partitioned_vector{std::move(gathered), std::move(partition)};
    }
